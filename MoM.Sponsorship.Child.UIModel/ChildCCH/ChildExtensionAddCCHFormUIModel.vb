...
Public Class ChildExtensionAddCCHFormUIModel

    Private Sub ChildExtensionAddCCHFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
    ...
    'Private Sub ChildExtensionAddCCHFormUIModel_Validating(ByVal sender As Object, ByVal e As AppFx.UIModeling.Core.ValidatingEventArgs) Handles Me.Validating
