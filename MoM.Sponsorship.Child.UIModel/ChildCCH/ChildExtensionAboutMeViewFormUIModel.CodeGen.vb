...
'------------------------------------------------------------------------------
''' <summary>
''' Represents the UI model for the 'ChildExtension About Me Form' data form
''' </summary>
<Global.Blackbaud.AppFx.UIModeling.Core.DataFormUIModelMetadata(Global.Blackbaud.AppFx.UIModeling.Core.DataFormMode.View, "ef8bff5a-5d50-4702-922a-905ed5cfd388", "ca862083-b06e-4f92-98d3-fc4b883c8f38", "Child Extension")> _
Partial Public Class [ChildExtensionAboutMeViewFormUIModel]
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.DataFormTemplateId = New Guid("ef8bff5a-5d50-4702-922a-905ed5cfd388")
        MyBase.DataFormInstanceId = New Guid("ca862083-b06e-4f92-98d3-fc4b883c8f38")
        MyBase.RecordType = "Child Extension"
        MyBase.FixedDialog = True
        MyBase.UserInterfaceUrl = "browser/htmlforms/custom/ChildExtensionAboutMeViewForm.html"
        ...
        _myfavoritethingtodo.DBReadOnly = True
        ...
        _wheniplaywithfriendswe.DBReadOnly = True
        ...
        _whenathomeihelpoutby.DBReadOnly = True
        ...
        _whenitalktogodiaskhim.DBReadOnly = True
        ...
        _twomostfavoritethings.DBReadOnly = True
        _twomostfavoritethings.MaxLength = 1000
        _twomostfavoritethings.MultiLine = True
        _twomostfavoritethings.AllowZoom = True
        ...
        _otherthingsthechildenjoys.DBReadOnly = True
