Public Class ChildDepartureGeneralCommentsEditDataFormUIModel

    Private Sub ChildDepartureGeneralCommentsEditDataFormUIModel_Loaded(ByVal sender As Object, ByVal e As Blackbaud.AppFx.UIModeling.Core.LoadedEventArgs) Handles Me.Loaded
